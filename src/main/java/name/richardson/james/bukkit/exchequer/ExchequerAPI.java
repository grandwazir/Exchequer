...
public interface ExchequerAPI {
   ...
   *
   * @param playerName the name of the player
   * @return the player's personal account or null if the player is not registered.
   */
   ...
   * 
   * This method will create a new PlayerRecord and an associated personal AccountRecord set to the initial default balance specified in the configuration of Exchequer.
   *
   * Calling this method on a player who is already registered is safe and will make no changes.
   *
   * @param playerName the name of the player
   ...
   *
   * This will need to be used in order to save your changes to an AccountRecord or a PlayerRecord after modifying them directly.
   *
