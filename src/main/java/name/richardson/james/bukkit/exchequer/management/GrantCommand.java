...
public class GrantCommand extends PluginCommand {
  ...
  public void execute(CommandSender sender) throws CommandArgumentException, CommandPermissionException, CommandUsageException {
    ...
    if (playerName != null) {
      ...
      this.alterBalance();
      Object[] tokens = {playerName, handler.formatAmount(amount)};
      sender.sendMessage(plugin.getSimpleFormattedMessage("grantcommand-personal-account-success", tokens));
    } else {
      ...
      this.alterBalance();
      Object[] tokens = {accountNumber, handler.formatAmount(amount)};
      sender.sendMessage(plugin.getSimpleFormattedMessage("grantcommand-bank-account-success", tokens));
    }
