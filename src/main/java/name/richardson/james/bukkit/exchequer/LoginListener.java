...
public class LoginListener implements Listener {
   ...
   * On player join.
   * 
   * When a player joins the server, check to see if they are currently
   * registered with Exchequer. If they are not create a new PlayerRecord and
   * AccountRecord for this player.
   * 
