...
public class AccountRecord implements Balance {
  ...
  /** The id (primary key) of the account. Also referenced as the account number and used in various commands. */
  @Id
  private int id;
  ...
  public double add(double amount) {
    ...
    if (proposal < 0) throw new IllegalArgumentException("Balances can not be negative.");
